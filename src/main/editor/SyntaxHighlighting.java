...
public class SyntaxHighlighting
{
    ...
    private final String keywords = "if else while do include memory proc const end offset reset assert in print dup over drop swap";
    ...
    {
        Runnable doHighlightAll = new Runnable() {
            @Override
            public void run()
            {
    ...
    private void StyleWord(int start, int end) throws BadLocationException
    {
